            ...
            <div class="nano-content">
                <ul>
                   ...
                   <!-- <li><a href="{{route('booking.list')}}">Tour Bookings </a></li>
                    ...
                    <li><a href="{{route('basic.from')}}"><i class="ti-layout"></i> Inquiries <span
                                class="sidebar-collapse-icon ti-angle-down"></span></a></a>
                       <!-- <ul>
                    ...
                    <li><a class="sidebar-sub-toggle"><i class="ti-panel"></i> Rate & Reviews <span
                                class="sidebar-collapse-icon ti-angle-down"></span></a>
                        <ul>
                    ...
                    <li><a class="sidebar-sub-toggle"><i class="ti-layout-grid4-alt"></i> Payment details<span
                                class="sidebar-collapse-icon ti-angle-down"></span></a>
                        <ul>
