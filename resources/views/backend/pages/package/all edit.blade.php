                        ...
                        <div class="col-lg-10">
                            <div class="card">
                                ...
                                <div class="card-body">
                                        ...
                                        <form method="post" action="{{route('all.update',$type->id)}}">
                                           
                                        @csrf
                                         @method('put')   
                                        <div class="form-group ">
                                                <p class="text-muted m-b-15 f-s-12">Place Name</p>
                                                <input value="{{$type->name}}" type="text" name="placename" class="form-control input-default " placeholder="Plz enter place name">
                                            ...
                                            <div class="form-group ">
                                                ...
                                                <input value="{{$type->details}}" type="text" name="placedetails" class="form-control input-default " placeholder="Plz enter place details">
                                                <span style="color:red;">
                                                    <strong></strong>
                                                </span>
                                            </div>
                                            <div class="form-group ">
                                                ...
                                                <input value="{{$type->package_start_date}}"  type="date" name="packagstartdate" class="form-control input-default " placeholder="plz enter start package date">
                                                
                                            </div>

                                            <div class="form-group ">
                                                <p class="text-muted m-b-15 f-s-12">Package End Date</p>
                                                <input value="{{$type->package_end_date}}"  type="date" name="packagenddate" class="form-control input-default " placeholder="plz enter end package date">
