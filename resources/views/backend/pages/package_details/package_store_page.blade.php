                        ...
                        <div class="col-lg-10">
                            <div class="card">
                                ...
                                <div class="card-body">
                                        ...
                                        <!-- <form method="post" action="{{route('packagedetails.store')}}">
                                        @csrf -->
                                        <form>
                                        <div class="form-group ">
                                                <p class="text-muted m-b-15 f-s-12">Package Name</p>
                                                <input type="text" name="name" class="form-control input-default " placeholder="Plz enter place name">
                                            ...
                                            <div class="form-group ">
                                                <p class="text-muted m-b-15 f-s-12">Place Details1</p>
                                                <textarea type="text" name="details1" class="form-control input-default " placeholder="Plz enter place details">
                                                <span style="color:red;">
                                                    <strong></strong>
                                                </span>
                                            </div>
                                            ...
                                            <div class="form-group ">
                                                <p class="text-muted m-b-15 f-s-12">Place Details2</p>
                                                <textarea type="text" name="details2" class="form-control input-default " placeholder="Plz enter place details">
                                                <span style="color:red;">
                                                    <strong></strong>
                                                </span>
                                            </div>
                                            ...
                                            <div class="form-group ">
                                                <p class="text-muted m-b-15 f-s-12">Package Price</p>
                                                <input type="number" name="price" class="form-control input-default " placeholder="Plz enter place name">
                                                <span style="color:red;">
                                                    <strong></strong>
                                                </span>
